          ...
          return (
            <li key={participant.id} className="rounded-md px-2.5 py-2 hover:bg-[var(--hover)]">
              ...
              {localAgent?.activity ? (() => {
                ...
                return (
                  <div className="mt-2 rounded border border-[var(--border)] bg-[var(--bg)] p-2 text-[11px]" aria-live="polite">
                    <p className="font-medium">{phase} · {elapsedLabel(localAgent.activity.startedAt, now)}</p>
