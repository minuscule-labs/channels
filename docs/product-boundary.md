...
4. ~~Add private configuration UI.~~ Implemented with redacted state and write-only replacement forms. Next add Channel creation, participant assignment, and existing-Channel membership mutation.
